...
export const fujisanCraftPillars: CraftPillar[] = [
  ...
  },
  {
    ...
    lead: "Yamadanishiki, Miyama Nishiki, Omachi — heirloom sakamai grown by partner farms whose families have polished their craft alongside ours for generations.",
    ...
    storyEn: [
      ...
      "We work directly with terraced farms in Yamanashi, Hyogo, and Okayama. Their soil, their water, and their hands shape the ingredient long before it ever reaches our tanks. Some plots have been brewing for us across three generations.",
    ...
    storyJp: [
      ...
      "山梨・兵庫・岡山の契約農家とともに、土と水と人の仕事から米を選びます。三代にわたり弊蔵に米を届けてくださる田もあります。",
    ...
    stats: [
      { label: "VARIETIES", value: "3", caption: "Yamadanishiki · Miyama · Omachi" },
      { label: "POLISH RATE", value: "40–60%", caption: "By weight remaining" },
      { label: "PARTNER FARMS", value: "12", caption: "Across 3 prefectures" },
