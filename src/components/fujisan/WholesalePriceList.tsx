    ...
    <div>
      ...
      <p className="ed-small mt-7">
        <L
          ...
          ja="価格は1本あたり（300ml／180ml）・税抜の参考価格です（アジア向け CIF 概算）。最小ロットは1出荷あたり3,000本（銘柄混載可）です。正式なお見積りは担当窓口までご相談ください。"
        />
      </p>
    </div>
  );
  ...
  return (
    <Gate
      ...
      body={
        rejected ? (
          <L
            en="If your situation changes, please get in touch and we will look again."
