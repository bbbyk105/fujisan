    ...
    <section id="story" ref={ref}>
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="bg-ink2 px-[clamp(32px,5vw,80px)] py-[clamp(48px,7vw,100px)] flex flex-col justify-center border-l border-gold/15 max-md:border-l-0 max-md:border-t max-md:border-gold/15">
          ...
          <h2 className="reveal d1 font-serif text-[clamp(36px,6vw,72px)] font-light leading-[1.05] mb-7">
          ...
          <p className="reveal d3 text-[clamp(15px,2vw,17px)] leading-[1.85] text-off-white/72 max-w-[540px] mt-[18px]">
            A Junmai Daiginjo of the highest order — not simply sake,
            but a meditation on place, season, and spirit.
          </p>
          <div className="reveal d3 font-jp text-sm font-extralight leading-[2.2] text-off-white/50 mt-9 pt-9 border-t border-gold/20">
            富士山の麓、田貫湖のほとりで<br />
            静かに醸される天地星空。<br />
            星空を映す湖面のように<br />
            透明で深い味わいを一滴一滴に込めました。
