        ...
        <div className="min-w-[240px]">
          <p className="font-serif text-[14.5px] font-semibold tracking-[0.04em] text-[#0B1A2E]">
            ...
            {!customer.emailVerified && (
              <span className="ml-2 border border-[#C9A84C]/55 px-2 py-0.5 text-[9.5px] font-semibold tracking-[0.18em] text-[#8A6D1F]">
                メール未確認
              </span>
            )}
          </p>
          <p className="mt-1 text-[11.5px] text-[#0B1A2E]/65">
            {customer.email}
            {customer.phone && (
              <>
          ...
          {customer.address && (
            <p className="mt-1 text-[11.5px] text-[#0B1A2E]/55">
