...
export function ResendVerification({
  ...
  if (state === "sent") {
    return (
      <p className="text-[12px] leading-[1.7] text-indigo/75">
        <L
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <button
        ...
        className="inline-flex w-fit cursor-pointer items-center gap-2 text-[12.5px] font-semibold text-indigo underline decoration-gold/60 underline-offset-4 transition-colors hover:decoration-gold disabled:cursor-not-allowed disabled:opacity-60"
      >
        {state === "sending" ? (
      ...
      {state === "error" && (
        <p className="text-[11.5px] leading-[1.6] text-crimson">
          <L
